...
- (void)LeftfilterData:(float *)data numFrames:(UInt32)numFrames numChannels:(UInt32)numChannels;
- (void)RightfilterData:(float *)data numFrames:(UInt32)numFrames numChannels:(UInt32)numChannels;
